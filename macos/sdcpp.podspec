  ...
  s.script_phases = [
    {
      ...
      :input_files => ["${PODS_TARGET_SRCROOT}/src/stable_diffusion/ggml/src/ggml-metal/*.metal"],
      ...
      :script => <<-SCRIPT
        ...
        set -u
        set -o pipefail
        cd "${PODS_TARGET_SRCROOT}/src/stable_diffusion"
        xcrun metal \
          -I"${PODS_TARGET_SRCROOT}/src/stable_diffusion/ggml/src" \
