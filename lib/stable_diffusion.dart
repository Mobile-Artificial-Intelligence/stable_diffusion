...
import 'stable_diffusion_bindings_generated.dart';
...
const String _libName = 'stable_diffusion';

/// The dynamic library in which the symbols for [StableDiffusionBindings] can be found.
...
final StableDiffusionBindings _bindings = StableDiffusionBindings(_dylib);
